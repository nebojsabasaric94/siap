...
namespace BackPropagationAlgorithm
{
    ...
    {
        public static int MAXN = 40;      //Maximalan broj neurona po slojevima
        public static int SLOJEVI = 3;   //Ukupan broj slojeva
        public static int uzorciN = 300;   //Ukupan broj uzoraka
        ...
        protected void inicijalizacija()
        {
            ...
            ni = 0.05;
            beta = 0.5;
            slojevi[0].n = 40;  //broj neurona ulaznog sloja
            slojevi[1].n = 22;  //broj neurona skrivenog sloja
